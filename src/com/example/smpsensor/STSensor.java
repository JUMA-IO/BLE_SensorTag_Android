package com.example.smpsensor;

import java.util.HashMap;
import java.util.UUID;

import com.example.smpsensor.CustomDialog.Callback;
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						case 0x02:
							...
							break;
						case 0x03:
							tv4.setText(""+(double)x/100+"μt");
							tv5.setText(""+(double)y/100+"μt");
							tv6.setText(""+(double)z/100+"μt");
